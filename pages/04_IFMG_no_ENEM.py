...
with c4:
    ...
    campus_sel = st.selectbox("🏛️ Selecione um campus", CAMPUS_CIDADES, key="campus_ts")
...
# ─── Dispersão ───
st.markdown("### ✍️ Matemática vs Redação: O Diferencial IFMG")
...
st.markdown("## ⚔️ Capítulo 5: IFMG vs as Demais Redes nos Mesmos Municípios")
st.markdown("Como o IFMG (Federal) se compara com as redes Estadual, Municipal e Privada nas mesmas cidades?")

campus_comp = st.selectbox("🏛️ Campus", CAMPUS_CIDADES, key="campus_comp")
